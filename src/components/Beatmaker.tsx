      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            ...
            <Card className="bg-gray-800/50 border-gray-600">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-white">16-Step Sequencer</CardTitle>
              ...
              <CardContent>
                <div className="space-y-4">
                  {/* Step indicators */}
                  <div className="flex gap-1 mb-4 pl-40">
                        ...
                        {track.pattern.map((active, stepIndex) => (
                          <button
                            ...
                            className={`w-8 h-8 rounded border-2 transition-all ${
                              active
                                ? 'bg-green-500 border-green-400 shadow-green-500/50 shadow-lg'
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gray-800/50 border-gray-600">
              <CardHeader>
                <CardTitle className="text-white">Effects & Autotune</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <label className="text-white text-sm">Autotune</label>
                  <Switch
                ...
                {effects.autotune && (
                  <div className="space-y-2">
                    <label className="text-white text-sm">Key: {effects.autotuneKey}</label>
                    <select
                    ...
                    <label className="text-white text-sm">Strength: {effects.autotuneStrength}%</label>
                    <Slider
                ...
                <div>
                  <label className="text-white text-sm">Reverb: {effects.reverb}%</label>
                  <Slider
                ...
                <div>
                  <label className="text-white text-sm">Delay: {effects.delay}%</label>
                  <Slider
                    value={[effects.delay]}
                    onValueChange={(value) => 
            ...
            <Card className="bg-gray-800/50 border-gray-600">
              <CardHeader>
                <CardTitle className="text-white">Export & Record</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <Button
                  onClick={exportToWAV}
                ...
                <div className="space-y-2">
                  <div className="text-white text-sm">Recorded Beats:</div>
